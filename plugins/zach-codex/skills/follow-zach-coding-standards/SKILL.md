---
name: follow-zach-coding-standards
description: Apply Zach's coding, tooling, validation, Git, and MCP preferences. Use when implementing, modifying, reviewing, debugging, or refactoring code; when choosing a stack for new work; or when using documentation, TypeScript inspection, logs, Linear, or deployment tools for engineering tasks.
---

# Follow Zach Coding Standards

Apply the standards that match the current task while preserving higher-priority user and repository instructions.
